...
const Eyes = () => {
  ...
  return (
    <div className="eyes w-full h-screen overflow-hidden my-10">
      <div
        data-scroll
        data-scroll-section
        data-scroll-speed="-.7"
        className="relative w-full h-full bg-cover bg-center b bg-[url('https://ochi.design/wp-content/uploads/2022/05/Top-Viewbbcbv-1-scaled.jpg')]"
      >
