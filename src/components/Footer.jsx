...
const Footer = () => {
  let socialss = ["Instagram", "Behance", "Facebook", "Linkedin"];
  return (
    <div
      data-scroll
      data-scroll-section
      data-scroll-speed="-.2"
      className="bg-zinc-900 w-full min-h-screen rounded-t-2xl flex"
    >
      <div className="w-1/2 h-screen text-zinc-100 p-[3vw] flex flex-col justify-between">
        <h1 className="uppercase font-['Grotesk'] text-[9vw] w-1/4 leading-[7vw] ">
          eye-opening
        </h1>
        <div className="">
          <svg
      ...
      <div className="w-1/2 h-screen  text-zinc-100 flex flex-col">
        <h1 className="uppercase font-['Grotesk'] text-[9vw]">Presentations</h1>
        <div className="socials py-4 flex w-[10vw] flex flex-col ">
          <h1 className="text-3xl font-['Neue'] tracking-wider mb-4 uppercase">
            S:
          </h1>

          {socialss.map((items) => (
            <h2 className="text-2xl font-['Neue'] tracking-wide leading-[1.8vw] underline">
              {items}
            </h2>
          ))}
        </div>
